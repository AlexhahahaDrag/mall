...
public class RegexUtil {
    ...
    /**
     * @Description: Regex of exact mobile.
    ...
    */
    ...
    /*Regex of card number which length is 15*/
    public static final String REGEX_ID_CARD15 = "^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$";

    /*Regex of card number which legth is 18*/
    public static final String REGEX_ID_CARD18 = "^[1-9]\\d{5}[1-9]\\d{4}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}([0-9Xx])$";
    ...
    /**
     * @Description: Regex of username
     * scope for "a-z","A-Z","0-9","Chinese character"
     * can't end with "_"
    ...
    */
    ...
    public static final String REGEX_DATE = "^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[1-9]|2[1-8])|" +
            "(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[4,8]|[2468][048]|[13579][26])|" +
            "(?:0[]48|[2468][048]|[13579][26])00)-02-29)$";

    /*Regex of ip address*/
    public static final String REGEX_IP = "((2[0-4]\\d|25[0-5]|[01]?\\d\\d?)\\.){3}(2[0-4]\\d|25[0-5]|[01]?\\d\\d?)";

    /*Regex of double-byte character*/
    ...
    /*Regex of postal code*/
    public static final String REGEX_CHINA_POSTAL_CODE = "[1-9]\\d{5}(?!\\d)";

    /*Regex of positive integer*/
    public static final String REGEX_POSITIVE_INTEGER = "^[1-9]\\d*$";

    /*Regex of negetive integer*/
    public static final String REGEX_NEGETIVE_INTEGER = "^-[1-9]\\d*$";
