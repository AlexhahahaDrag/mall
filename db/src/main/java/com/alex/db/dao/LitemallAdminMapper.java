...
public interface LitemallAdminMapper {
    ...
    LitemallAdmin selectByPrimarKeyWithLogicalDelete(@Param("id") Integer id, @Param("andLogicalDeleted") boolean andLogicalDeleted);
    ...
    int logicalDeleteByPromaryKey(Integer id);
}
