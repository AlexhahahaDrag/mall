...
import com.alex.adminapi.vo.PermVo;
...
public class PermissionUtil {
    ...
    public static List<PermVo> listPermVo(List<Permission> permissions) {
        ...
        for (Permission permission : permissions) {
            ...
            if (menus.length != 2)
                throw new RuntimeException("目前菜单只支持两级");
            ...
            if (leftPerm == null) {
                ...
                throw new RuntimeException("权限已存在，不能添加新权限");
        }
        return root;
    }
    ...
    public static List<Permission> listPermission(ApplicationContext context, String basicPackage) {
        ...
        for(Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            for (Method method : methods) {
                ...
                //这里只支持GetMapping 注解或 PostMapping 注解，应该进一步提供灵活性
